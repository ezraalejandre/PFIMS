...
<body class="dashboard-page">
    ...
    <aside class="sidebar">
                <nav>
            <ul>
                <li class="active"><a href="{{ url('/adashboard') }}"><img src="{{ asset('images/dashboard.png') }}" alt="" class="nav-link-icon">DASHBOARD</a></li>
    ...
    <main class="main-content">
        ...
        <div class="budget-section">
            ...
            <div class="pagination-wrapper">
                    ...
                    <span id="budgetRowsInfo" class="pagination-total">Total: 0</span>
                </div>
    ...
    <script>
        ...
        function changeBudgetPageSize() {
            ...
            if (!rowsInfo) return;
            rowsInfo.textContent = 'Total: ' + totalCount;
        }
