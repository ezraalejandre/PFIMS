...
<body class="inventory-page">
    ...
    <aside class="sidebar">
            ...
            <ul>
                ...
                <li class="active"><a href="{{ url('/oinventory') }}"><img src="{{ asset('images/inventory.png') }}" alt="" class="nav-link-icon">INVENTORY</a></li>
    ...
    <div id="editItemModal" class="modal-overlay modal-add-item">
        <div class="modal-container">
            ...
            <div class="modal-footer">
                ...
                <button class="btn-save" id="saveEditItemBtn" onclick="saveEditItem()">Save Changes</button>
            </div>
        </div>
    </div>
        ...
        <div class="modal-container">
            ...
            <div class="modal-step" id="step2" style="display: none;">
                ...
                <div class="modal-footer">
                    ...
                    <div class="footer-right">
                        <button class="btn-save" id="saveTransactionBtn" onclick="saveTransaction()">Add Transaction</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="expenseModal" class="modal-overlay modal-expense">
        <div class="modal-container">
            ...
            <div class="modal-footer">
                ...
                <button class="btn-save" id="saveExpenseBtn" onclick="saveExpenseFromTransaction()">Create Expense</button>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function saveNewItem() {
            var btn = document.getElementById('saveNewItemBtn');
        ...
        function saveEditItem() {
            var btn = document.getElementById('saveEditItemBtn');
            if (btn && btn.disabled) return;
        ...
        function saveTransaction() {
            var btn = document.getElementById('saveTransactionBtn');
            if (btn && btn.disabled) return;
        ...
        function saveEdit() {
            ...
            var btn = document.getElementById('viewSaveBtn');
            if (btn && btn.disabled) return;
