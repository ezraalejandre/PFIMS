...
<head>
    ...
    <title>Accounting Notifications - PFIMS</title>
    <link rel="stylesheet" href="{{ asset('css/Anotifications.css') }}">
    <style>
...
<body class="notifications-page">
    ...
    <script>
        ...
        // ─── ROLE-RELEVANT NOTIFICATION TYPES (Accounting) ───
        ...
        function loadNotifications() {
            ...
            .then(function(response) {
                ...
                return response.json();
                        ...
                        .then(function(data) {
                var roleFiltered = (data.notifications || []).filter(function(n) { return isRoleRelevant(n.type); });
                allNotifications = filterMutedNotifications(roleFiltered);
                updateBadgeCount();
                renderNotifications();
            })
        ...
        function loadMockNotifications() {
            ...
            allNotifications = [
                ...
                },
                {
                    notification_id: 2,
                    title: 'Budget Threshold Reached',
                    message: 'Harbor View Residences has consumed 92% of its allocated budget.',
                    type: 'budget_threshold_total',
                    kind: 'warning',
                    filter: 'alerts',
                    is_read: false,
                ...
                },
                {
                    ...
                    message: '3 project budgets are near or over the spending limit.',
                ...
                },
                {
                    ...
                    message: 'EVC-DCS was updated to v2.4.1. See release notes.',
                    type: 'system_update',
                    kind: 'system_update',
                    filter: 'system',
                    is_read: true,
                ...
                },
                {
                    ...
                    message: '5 projects have exceeded their allocated budget by more than 10%.',
                    type: 'budget_overrun_total',
                    kind: 'overdue',
                    filter: 'alerts',
                    is_read: false,
                    created_at: new Date(now.getTime() - 1000 * 60 * 60 * 2).toISOString()
                        ...
                        allNotifications = filterMutedNotifications(allNotifications.filter(function(n) { return isRoleRelevant(n.type); }));
            updateBadgeCount();
            renderNotifications();
        }
