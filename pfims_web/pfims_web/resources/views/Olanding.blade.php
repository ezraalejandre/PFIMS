...
<body>
    ...
    <div class="container">
        ...
        <div class="form-wrapper">
            ...
            <p class="form-subtitle">Please enter your operations credentials below</p>

            <form action="{{ url('/ologin') }}" method="POST" onsubmit="return validateLogin(event)">
                @csrf
            ...
            <div class="footer-text">
                <strong>Operations Department Access</strong>
            </div>
        </div>
