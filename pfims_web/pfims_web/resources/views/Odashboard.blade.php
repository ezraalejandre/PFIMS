...
<body class="dashboard-page">
    ...
    <aside class="sidebar">
                <nav>
            <ul>
                <li class="active"><a href="{{ url('/odashboard') }}"><img src="{{ asset('images/dashboard.png') }}" alt="" class="nav-link-icon">DASHBOARD</a></li>
    ...
    <main class="main-content">
        ...
        <div class="pagination-wrapper" id="projectsPagination" style="margin-top: 15px; display: none;">
                ...
                <span id="projectsTotalCount" class="pagination-total">Total: 0</span>
            </div>
    ...
    <script>
                ...
                var budgetDisplay = '₱0.00';
                    ...
                    <div class="project-item" 
                        ...
                        onclick="openProjectDetail(this)">
                            ...
                            <div class="budget">Client: ${project.client_name || '—'} | Status: <span class="status-text ${getStatusClass(status)}">${status}</span></div>
                        </div>
        ...
        function updateProjectsPagination() {
            ...
            document.getElementById('projectsPagination').style.display = totalPages > 1 ? 'flex' : 'none';
                        document.getElementById('projectsTotalCount').textContent = 'Total: ' + total;
    ...
    window.location.href = "{{ url('/oprojects') }}" + (id ? '?project=' + id : '');
}
