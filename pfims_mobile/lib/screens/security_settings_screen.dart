...
class _SecuritySettingsScreenState
  ...
  // ──────────────────────────────────────────────────────────
  // 2FA Variables (commented out - kept for future use)
  // ──────────────────────────────────────────────────────────
  // bool _twoFactorEnabled = true;
  // String _twoFactorMethod = "Email";

  // ──────────────────────────────────────────────────────────
  // Session Variables (commented out - kept for future use)
  // ──────────────────────────────────────────────────────────
  ...
  // ──────────────────────────────────────────────────────────
  // 2FA Edit Function (commented out - kept for future use)
  // ──────────────────────────────────────────────────────────
  // void _editTwoFactor(){
  //   showDialog(
  //     context: context,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: const _SecurityAppBar(),
      body: ListView(
        padding: const EdgeInsets.fromLTRB(16, 24, 16, 24),
        children: [
          // ──────────────────────────────────────────────────────────
          // PASSWORD SECTION - KEPT
          // ──────────────────────────────────────────────────────────
          _Card(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
          ...
          // ──────────────────────────────────────────────────────────
          // LOGIN SESSIONS SECTION - COMMENTED OUT
          // ──────────────────────────────────────────────────────────
          // const SizedBox(height: 16),
          // _Card(
          //   child: Column(
      ...
      child: Row(
        children: [
          Container(
            ...
            height: 36,
            decoration: BoxDecoration(
              color: kBrandOrange.withOpacity(.14),
